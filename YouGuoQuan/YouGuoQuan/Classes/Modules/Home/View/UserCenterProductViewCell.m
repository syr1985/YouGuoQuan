...
- (void)setUserCenterModel:(UserCenterModel *)userCenterModel {
    ...
    NSString *productImageUrlStr = [NSString cropImageUrlWithUrlString:userCenterModel.imageUrl
    ...
    //_buyButton.enabled = ![userCenterModel.userId isEqualToString:[LoginData sharedLoginData].userId];
}
