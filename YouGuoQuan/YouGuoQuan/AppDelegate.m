...
// 高德地图key
#define GaoDeMap_Key        @"6848172b30c1355339e3dd8d901bea51"
...
//    [iVersion sharedInstance].viewedVersionDetails = NO;
...
//    [AppVersionTool judgeAppStoreVersion];
...
- (void)configSVProgressHUD {
    ...
    [SVProgressHUD setBackgroundColor:[UIColor colorWithWhite:0.7 alpha:1]];
...
- (void)userNotificationCenter:(UNUserNotificationCenter *)center willPresentNotification:(UNNotification *)notification withCompletionHandler:(void (^)(UNNotificationPresentationOptions))completionHandler {
    ...
    if ([notification.request.trigger isKindOfClass:[UNPushNotificationTrigger class]]) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:kNotification_RefreshUnreadMsgNumber object:nil];
